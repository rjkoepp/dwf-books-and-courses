...
<div align='center'>
	...
	<figcaption>Figure 1 Largest stock exchanges (Source: [5])</figcaption>
</div>
...
> **Candidate:** Which securities are we going to trade? Stocks, options, or futures?<br />
> **Interviewer:** For simplicity, only stocks.
> 
> **Candidate:** Which types of order operations are supported: placing a new order, canceling an order, or replacing an order? Do we need to support limit order, market order, or conditional order?<br />
...
> 
> **Candidate:** Does the system need to support after-hours trading?<br />
> **Interviewer:** No, we just need to support the normal trading hours.
> 
> **Candidate:** Could you describe the basic functions of the exchange? And the scale of the exchange, such as how many users, how many symbols, and how many orders?<br />
...
> 
> **Candidate:** Could you please elaborate on risk checks?<br />
...
> 
> **Candidate:** I noticed you didn’t mention user wallet management. Is it something we also need to consider?<br />
...
<div align='center'>
	...
	<figcaption>Figure 2 Level 1 data</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 3 Level 2 data</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 4 Level 3 data</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 5 A single candlestick chart</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 7 Inbound and outbound sequencers</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 8 Client gateway components</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 9 Client gateway</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 10 Market Data Publisher</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 11 Reporter</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 12 Product, order, execution</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 13 Limit order book illustrated</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 14 Place, match, and cancel an order in O(1)</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 15 A low latency single server exchange design</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 16 Application loop thread in Order Manager</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 17 Non-event sourcing vs event sourcing</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 18 An event sourcing design</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 19 Sample design of Sequencer</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 20 Hot-warm matching engine</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 21 Event replication in Raft cluster</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 22 Raft terms (Source: [23])</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 23 Time in event sourcing</figcaption>
</div>
...
<div align='center'>
	...
	<figcaption>Figure 24 Market Data Publisher</figcaption>
</div>
